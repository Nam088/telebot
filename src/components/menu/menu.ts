...
import type { InlineKeyboardMarkup } from "../../client/types.js";
...
import { buildMenuKeyboard, renderMenuKeyboard } from "./renderer.js";
...
export class Menu {
  ...
  public build(ctx?: CallbackContext): InlineKeyboardMarkup {
    return buildMenuKeyboard(this.id, this.rows, ctx);
  }
  ...
  public async render(ctx?: CallbackContext): Promise<InlineKeyboardMarkup> {
    return renderMenuKeyboard(this.id, this.rows, ctx);
  }
