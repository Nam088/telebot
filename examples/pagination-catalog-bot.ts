...
const PRODUCTS: Product[] = [
  ...
  { id: "p3", name: "Premium Membership (1 Year)", price: 450, description: "Best value, save 25%" },
  ...
  { id: "p6", name: "Custom Bot Verification Badge", price: 1000, description: "Official checkmark" },
...
function renderCatalogPage(page: number) {
  ...
  const text = `${bold("🛍️ Digital Store Catalog")}\n\n` +
