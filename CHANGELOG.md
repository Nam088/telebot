...
* **ci:** remove dist release assets upload to prevent ReleaseAsset already_exists conflict ([8ce0f63](https://github.com/Nam088/telebot/commit/8ce0f632026a5241a711909e5254f4736afa3cfc))
...
* **ci:** switch semantic-release preset to angular to fix conventional-changelog-writer version conflict ([8706abb](https://github.com/Nam088/telebot/commit/8706abbe802f406e950311e7fb1cd0386897b42b))
...
* **ci:** use safe HTML formatting for telegram notifications ([44800fe](https://github.com/Nam088/telebot/commit/44800fe6fdb40da7836e198650d8f53ead10b93f))
* **ci:** use success lifecycle hook for post-release notes update ([ecb8b62](https://github.com/Nam088/telebot/commit/ecb8b6242536bbe31671653e2c61533f188509ec))
...
* **deps:** upgrade tsup, vitest@3.2, @semantic-release/npm to patch dev dependency vulnerabilities ([c78ec78](https://github.com/Nam088/telebot/commit/c78ec7886cee3ad5e905b4264670af6670283775))
...
* **menu:** enhance dynamic label evaluation and attach ctx.menu.update helper ([1014f78](https://github.com/Nam088/telebot/commit/1014f78cc49e47ab99557ea1781f54a53f65f446))
...
* **release:** release patch v1.1.1 with clean npm metadata, full Telegram 8.x parity, and nested menus ([d58e094](https://github.com/Nam088/telebot/commit/d58e094f935c5c1cd637d90fa4b8568ea8bce069))
* **routing:** recursively extract regex capture groups in composite and nested filters ([e14d366](https://github.com/Nam088/telebot/commit/e14d3664b8b9b435654c8af563198ead6b655d1e))
* **scheduler:** fix 6 critical RRule & Scheduler persistence issues ([690292f](https://github.com/Nam088/telebot/commit/690292f2b3c88fd8d1845004f5cb420527cd91b0))
* **scheduler:** fix RRule startMs anchor calculation when dtstart is omitted ([825aea8](https://github.com/Nam088/telebot/commit/825aea866f9b5498104d3c246d69936d0f7bd6d6))
* **scheduler:** resolve pre-start job scheduling, Node 24.8-day timer overflow, drift compensation, and centralized error handling ([0af6cb2](https://github.com/Nam088/telebot/commit/0af6cb2e0db8cf7703feeb77eff22a259f169d81))
...
* **types:** eliminate unused type imports and ensure 0 lint warnings ([0eabc8d](https://github.com/Nam088/telebot/commit/0eabc8dd548925db0099a23bc923311d871f5a28))


### Features

* add advanced Bot API methods (copyMessage, forwardMessage, myCommands, forumTopics) and context.reply shortcuts ([d65eb33](https://github.com/Nam088/telebot/commit/d65eb33207c268a81a65f11cb5d259735f3eb698))
* **api:** complete 100% full parity with Telegram Bot API 10.0, 10.1 & 10.2 Changelog additions and tests ([7b164e5](https://github.com/Nam088/telebot/commit/7b164e5e565213da38259fdf38744c89e8ddc647))
* **api:** enable 100% native snake_case method and property access across all modules ([476a5ca](https://github.com/Nam088/telebot/commit/476a5ca7df87e5b669a20c311b384daeb8bff6bb))
* **api:** Telegram Bot API 10.3 support ([#4](https://github.com/Nam088/telebot/issues/4)) ([9263841](https://github.com/Nam088/telebot/commit/9263841826c6d79454bf5e0b2d27f6a374956866)), closes [#3](https://github.com/Nam088/telebot/issues/3)
* **ci:** add custom release notes plugin that auto-prepends installation section for npm, yarn, pnpm, bun ([5d48e35](https://github.com/Nam088/telebot/commit/5d48e352349cf564ce50402195112e6b82227094))
...
* **client:** implement Telegram 8.x methods, text formatting utilities, and customizable pagination keyboard ([06fb68f](https://github.com/Nam088/telebot/commit/06fb68f516b3cb85c3189027695b8710d7fdd6e7))
* **components:** add fluent type-safe InlineQueryResultBuilder and search bot example ([6a5f6b6](https://github.com/Nam088/telebot/commit/6a5f6b61168713dd845044551b99cc6ae7f3576e))
* **core:** add WebApp HMAC validation, Telegram 8.x handlers, NestJS decorators, and linear conversation timeout ([7809dc6](https://github.com/Nam088/telebot/commit/7809dc690e6ab2772a2e27a15a992d512543173a))
* **core:** complete Setup, Foundational, US1 MVP with constants, rules and templates ([7cd63da](https://github.com/Nam088/telebot/commit/7cd63da7b7a7d8e6349313e93f91d9171f4ad063))
* **core:** implement AutoRetry flood control engine, interactive nested Menu system, and linear AsyncConversation ([cf721e2](https://github.com/Nam088/telebot/commit/cf721e200556a8fcae2fa1cff20dc9a21f561db6))
* **core:** trigger initial automated semantic release via OIDC ([0531ea2](https://github.com/Nam088/telebot/commit/0531ea2add050eba27c0a04eb76f461483173edb))
* **ecosystem:** add framework webhook adapters, app middleware pipeline, rate limiting, and ReplyKeyboard v8 builder methods ([3915180](https://github.com/Nam088/telebot/commit/391518028efa26bb7d1d7121330d5918fecc05c5))
* **examples:** add live interactive group test bot ([8442a72](https://github.com/Nam088/telebot/commit/8442a7263a0a68b56d02928908f2e01ef1f1cfe6))
* **examples:** add live webhook demo with InlineQueryHandler, latency tracking, and rich HTML formatting ([e7b3708](https://github.com/Nam088/telebot/commit/e7b37081589135b0a8d53837a24fe289ba9c9513))
* **examples:** update live group test bot with Menu, AsyncConversation, and Pagination ([d67ad07](https://github.com/Nam088/telebot/commit/d67ad07d8ee227d74d60e1aac4d0be9c157a12da))
* **ext:** implement Phase 4 User Story 2 (T024-T031) with handlers, filters, keyboards, and bot methods ([f2df555](https://github.com/Nam088/telebot/commit/f2df555ee1df0080456402824a6f0b59fcb9b74c))
...
* **kernel:** add intuitive Express-style shorthands (command, hears, callbackQuery, on) and rich reply helpers ([75493ee](https://github.com/Nam088/telebot/commit/75493eeb7be25e2b9af1e7486b8b1b7f40f9d6da))
* **logger:** allow pluggable custom loggers (ILogger interface for Pino, Winston, Roarr) via logger.setLogger() or LoggerOptions ([b15eb03](https://github.com/Nam088/telebot/commit/b15eb03096ea8139614fa4ca74841f624c2b43c8))
* **nest:** add Multi-Bot support with named bot instances and isolated handler routing ([0aaabeb](https://github.com/Nam088/telebot/commit/0aaabeb42c5acec04613341d20a638db31fe71c7))
* **nest:** add zero-dependency NestJS wrapper module with @Update, @Command, @Hears, and @Action decorators ([6c1f1dd](https://github.com/Nam088/telebot/commit/6c1f1ddc0bac88608506bc6c0cbc5eff85d65b53))
...
* **parity:** achieve 100% full upstream method parity (182 public Bot API methods) with 0 missing methods ([d257c19](https://github.com/Nam088/telebot/commit/d257c19e56706a7d6f0c1e6f0f5f35cbba286b0d))
* **parity:** complete Phase 1 migration (batch messages, reactions, live locations, polls) with 100% tests green ([bd90b6a](https://github.com/Nam088/telebot/commit/bd90b6aaee24cd8a0211847d3015be847fd6d6d0))
* **parity:** complete Phase 3 & 4 (payments, telegram stars, profile, commands, and general forum topics) with 153/153 tests passing ([af23a77](https://github.com/Nam088/telebot/commit/af23a772994010e41b9712f87da93a2b974405fb))
* **parity:** complete Phase 5 (stories, business, games, passport, gifts, and boosts) with 100% test pass rate and 0 TypeDoc warnings ([ba000c5](https://github.com/Nam088/telebot/commit/ba000c57548cbee61d0eb69f23a6150c5665a2c1))
...
* **routing:** add LinearConversation engine for modern sequential async/await conversation flows (wait/ask/exit) ([4986bc9](https://github.com/Nam088/telebot/commit/4986bc98c5f152cb85a87ffa8ae856b2103d65ce))
* **scheduler:** achieve 100% standard rrule.js RFC 5545 API compliance with RRule constants, Weekday class, and nth() selector ([082896e](https://github.com/Nam088/telebot/commit/082896e10469c3faee9b602abd80c9bd6fa380f1))
* **scheduler:** add zero-dependency RFC 5545 RRule recurrence engine with full IANA Timezone support and runRRule method ([4b0ba6c](https://github.com/Nam088/telebot/commit/4b0ba6c802ad668aeb9c0e23d88d7dfc1f55452d))
* **scheduler:** implement Phase 6 User Story 4 (T041-T046) with JobQueue, Job, timers, and persistence integration ([f91f6e3](https://github.com/Nam088/telebot/commit/f91f6e3d7130614ff02a0dbc5e6487b2b029f5bb))
* **scheduler:** support complete RFC 5545 options (negative bymonthday, count, byyearday, nth qualifiers) with exhaustive test suite ([aa7a9b3](https://github.com/Nam088/telebot/commit/aa7a9b359c4a663ae815b28567bb17c10938c952))
...
* **storage:** add delete methods (deleteUserData, deleteChatData, deleteConversation) and BasePersistence abstract class ([24223e9](https://github.com/Nam088/telebot/commit/24223e9bde0d594f9b58a289acb5c70a4626f179))
* **storage:** implement Phase 5 User Story 3 (T032-T040) with ConversationHandler, JsonFilePersistence, and native SqlitePersistence ([8fd64d7](https://github.com/Nam088/telebot/commit/8fd64d76d8ec0ba125fc8d47b9f55994a1489abf))
* **utils:** add generic session middleware with MemorySessionStorage and extensible SessionStorage adapter ([0a12a53](https://github.com/Nam088/telebot/commit/0a12a53138c8e66fa8795a500935fc2e1187ccc7))
* **utils:** implement zero-dependency structured Logger with level filtering and ANSI formatting ([36212b2](https://github.com/Nam088/telebot/commit/36212b20c414af7545604c79d0b475e3a0952786))
* **webhook:** implement Phase 7 & 8 (T047-T058) with runWebhook, secret token validation, zero runtime dependencies, and 100% test pass ([634a733](https://github.com/Nam088/telebot/commit/634a7333fe458c66109aa8967d136861509b37ae))


### Performance Improvements

* **polling:** make update dispatch non-blocking and parallelize menu callback responses ([ae8de25](https://github.com/Nam088/telebot/commit/ae8de25974b922e33ffcb8153fdcf84db2c44f0a))
* **scheduler:** optimize getJobsByName and getJobsByChatId lookups from O(N) linear scans to O(1) multi-index Maps ([a4d1044](https://github.com/Nam088/telebot/commit/a4d104437609050720cbc591b15e3ce5ad0f5814))
* **scheduler:** optimize RRule.after next-date computation with hierarchical adaptive time stepping ([cd0772a](https://github.com/Nam088/telebot/commit/cd0772ac7b8ce284c2cbe871ceb6a313010c15ff))
* **storage:** enable SQLite WAL mode and implement crash-resilient atomic file writes in JsonFilePersistence ([559e721](https://github.com/Nam088/telebot/commit/559e721446f5c56b8d4d3d81542712732139f511))
